...
class ReadElastic(object):
    ...
    def readSM(self):
        j=0
        pars = {'1':{'ngridk':6, 'swidth':0.05},'2':{'ngridk':10, 'swidth':0.05},'3':{'ngridk':15, 'swidth':0.05},'4':{'ngridk':18, 'swidth':0.05},'5':{'ngridk':21, 'swidth':0.05},'6':{'ngridk':25, 'swidth':0.05},'7':{'ngridk':6, 'swidth':0.01},'8':{'ngridk':10, 'swidth':0.01},'9':{'ngridk':15, 'swidth':0.01},'10':{'ngridk':18, 'swidth':0.01},'11':{'ngridk':21, 'swidth':0.01},'12':{'ngridk':25, 'swidth':0.01},'13':{'ngridk':6, 'swidth':0.002},'14':{'ngridk':10, 'swidth':0.002},'15':{'ngridk':15, 'swidth':0.002},'16':{'ngridk':18, 'swidth':0.002},'17':{'ngridk':21, 'swidth':0.002},'18':{'ngridk':25, 'swidth':0.002},'19':{'ngridk':27, 'swidth':0.05},'20':{'ngridk':30, 'swidth':0.05},'21':{'ngridk':27, 'swidth':0.01},'22':{'ngridk':30, 'swidth':0.01},'23':{'ngridk':27, 'swidth':0.002},'24':{'ngridk':30, 'swidth':0.002},'25':{'ngridk':33, 'swidth':0.01},'26':{'ngridk':36, 'swidth':0.01},'27':{'gmaxvr':14},'28':{'gmaxvr':16},'29':{'gmaxvr':18},'30':{'gmaxvr':20}}
        #pars = {'o_7':{'dist':7},'o_11':{'dist':11},'o_15':{'dist':11},'o_21':{'dist':21}}
        #pars = {'27':{'gmaxvr':14},'28':{'gmaxvr':16},'29':{'gmaxvr':18},'30':{'gmaxvr':20}}
